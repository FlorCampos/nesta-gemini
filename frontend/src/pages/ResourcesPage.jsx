...
function ResourceCard({ item }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          {item.logo && !imgErr ? (
            ...
            // Initials fallback
            <span style={{ fontSize: 13, fontWeight: 700, color: item.pc }}>
              {item.name.charAt(0)}
            </span>
          )}
        </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            color: item.pc, background: item.pl,
          ...
          <div style={{
            ...
            color: B.charcoal, lineHeight: 1.3,
            marginBottom: 3,
          }}>
            {item.name}
          </div>
        ...
        {/* Chevron — only if there's a description to expand */}
        {hasDescription && (
          <div style={{
            flexShrink: 0,
            color: B.mutedLight,
      ...
      {/* ── Expanded section — full description + CTA ── */}
      {expanded && (
        <div style={{
          padding: '0 14px 14px',
          borderTop: `0.5px solid ${item.pl}`,
      ...
      {/* CTA visible even when collapsed (for items without description) */}
      {!hasDescription && (
